/*
 * Custom version to hide refresh ui indicator
 * 
 * 
...
namespace Tabi.Controls
{
    ...
    public class PullToRefreshLayout : ContentView
    {
        ...
        public static readonly BindableProperty ShouldImmediatelyEndRefreshProperty =
    BindableProperty.Create(nameof(IsPullToRefreshEnabled), typeof(bool), typeof(PullToRefreshLayout), true);


        public bool ShouldImmediatelyEndRefresh
        {
            get { return (bool)GetValue(ShouldImmediatelyEndRefreshProperty); }
            set { SetValue(ShouldImmediatelyEndRefreshProperty, value); }
        }
